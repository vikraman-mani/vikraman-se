...
public class RLContext : DbContext
{
    ...
    public DbSet<ProcedurePlanUser> ProcedurePlanUsers { get; set; }
    ...
    protected override async void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<ProcedurePlanUser>(typeBuilder =>
        {
            typeBuilder.HasKey(ppu => new { ppu.PlanId, ppu.ProcedureId, ppu.UserId });
            typeBuilder.HasOne(ppu => ppu.Plan).WithMany(p => p.ProcedurePlanUsers);
